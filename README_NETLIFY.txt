...
Not:
- Mail icin netlify/functions/send-code.js dosyasi kullanilir. En temiz kurulum icin Netlify Environment Variables alanina RESEND_API_KEY eklenebilir.
- Veritabani icin netlify/functions/database.js dosyasi ve @netlify/blobs paketi kullanilir.
