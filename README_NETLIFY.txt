...
Not:
- Mail icin send-code.js dosyasi Gmail + Google uygulama sifresiyle kullanilir. En temiz kurulum icin Netlify Environment Variables alanina EMAIL_PASS eklenebilir.
